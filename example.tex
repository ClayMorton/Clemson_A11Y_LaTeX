...
% 8. A layout grid is not a data table, so table tagging is off for it: no
...
% table/tagging=false inside a group; left open, it untags every later table.
