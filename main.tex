...
\begin{figure}\centering
  ...
  \includegraphics[width=0.35\linewidth,alt={Coiled gray network cables in even rows on a beige pegboard wall, the same photograph as above at a smaller size.}]{example}
\end{figure}
...
\begin{figure}\centering
  ...
  \includegraphics[width=0.35\linewidth,alt={Coiled gray network cables on a beige pegboard wall, shown again here as an example of a figure inside an appendix.}]{example}
\end{figure}
